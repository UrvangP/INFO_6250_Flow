...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark flex" style="justify-content: space-between;width: 100\%">
        <H1 style="color:white">Add Users To Project</H1>
				...
				<form:form modelAttribute="project" method="post">
		            ...
		            <div class="form-outline mb-4">
                      <c:forEach var="eng" items="${engineers}">
                          ...
                          <form:checkbox path="selectedUser" class="form-control" value="${eng}"/>
                      </c:forEach>
		            </div>
		            
		            <form:hidden path="id" value="${projId}"/>
