	          ...
	          <div class="card-body p-5 text-center">
				...
				<form:form modelAttribute="ticket" method="post">
					<div class="form-outline mb-4">
		              ...
		              <form:input path="ticketSubject" class="form-control form-control-lg"/>
		            </div>
		            <div class="form-outline mb-4">
		              <label class="form-label" for="typePasswordX-2">Description</label>
		              <form:input path="ticketDescription" class="form-control form-control-lg"/>
		            </div>
		            
		            <div class="form-outline mb-4">
		              <label class="form-label">Type</label>
		              <form:select path="ticketType">
		              	<form:option class="form-control form-control-lg" value="Story"/>
		              	<form:option class="form-control form-control-lg" value="Feature"/>
		              	<form:option class="form-control form-control-lg" value="Bug"/>
	                  </form:select>
		            </div>
		            
		            <form:hidden path="assignedProjectId" value="${myproject.id}" />
