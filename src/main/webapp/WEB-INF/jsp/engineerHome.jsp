...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark flex" style="justify-content: space-between;width: 100%;">
            <H1 style="color:white">Engineer Home</H1>
    ...
    <ul class="list-group">
	  ...
	  <li class="list-group-item"><a href="/workflow/ticket/view">My Ticket</a></li>
	  <li class="list-group-item"><a href="/workflow/ticket/assign">Open Tickets</a></li>
	</ul>
