...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark flex" style="justify-content: space-between;width: 100\%">
        <H1 style="color:white">Open Tickets</H1>
        ...
        <tbody>
            <c:forEach items="${tickets}" var="tic">
                <tr>
                    ...
                    <td>
                    	<form class="form-inline my-2 my-lg-0"  method="POST" action="assign">
                    		<input type="hidden" name="ticketNum" value="${tic.id}"/>
                			<button class="btn btn-outline-success my-2 my-sm-0" type="submit">Assign to Me</button>
            			</form>
            		</td>
                </tr>
            </c:forEach>
